<div class="row">
    <?php
        if (isset($_SESSION[APPS_SESSION])) {
            //  This method is called when you just want to close the session
            unset($_SESSION[APPS_SESSION], $_SESSION['User']);
        }
    ?>
    ...
    <div class="col-md-4" style="margin: 0.5rem auto;">
        ...
        <div class="input-with-icon" style="margin-top: 0.5rem;">
            <input type="text" class="form-control" placeholder="E-mail or Mobile" id="email" name="email">
