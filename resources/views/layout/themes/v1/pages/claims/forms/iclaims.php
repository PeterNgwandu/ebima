            ...
            <script type="text/javascript">
                $(function() {
                    var uploader = new plupload.Uploader({
                        ...
                        url : 'http://127.0.0.1/insurance/private/docs/upload',
                        ...
                        filters : {
                            max_file_size : '15mb',
                            mime_types: [
                                {title : "Images files", extensions : "jpg,jpeg,png,gif"},
                    ...
                    uploader.bind("FileUploaded", function(up, file, response) {
                        ...
                        if(number > 0){
                            var attachment = $('input[name=the_attachment]').val() ;
                                attachment = attachment +','+ number

                            //  swal({text: 'The value of upload is : '+ , icon: false, title: ""});
                            $('input[name=the_attachment]').val(attachment) ;
                        }
                    });
                });
